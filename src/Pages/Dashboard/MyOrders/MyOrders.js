...
const MyOrders = () => {
    ...
    const url = `https://assignment-hero-twelfth-server.vercel.app/bookingsProduct?email=${user?.email}`;
    ...
    const handleDeleteProduct = booking => {
        fetch(`https://assignment-hero-twelfth-server.vercel.app/bookingsProduct/${booking._id}`, {
            method: 'DELETE', 
            headers: {
                authorization: `bearer ${localStorage.getItem('accessToken')}`
            }
